                    ...
                    <div class="card-body">
                        <form method="POST" action=" {{ route('store.portfolio') }} " enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="portfolio_name" class="form-control" value="" type="text" id="example-text-input">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="portfolio_title" class="form-control" value="" type="text" id="example-text-input">
