                    ...
                    <div class="card-body">
                        <form method="POST" action=" {{ route('update.about') }} " enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="title" class="form-control" value="{{ $aboutpage->title }}" type="text" id="example-text-input">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="short_title" class="form-control" value="{{ $aboutpage->short_title }}" type="text" id="example-text-input">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($aboutpage->about_image))? url( $aboutpage->about_image):url('upload/no_image.jpg') }}">
                                </div>
                            </div>
